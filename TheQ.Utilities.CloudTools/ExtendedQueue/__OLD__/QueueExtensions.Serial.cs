			...
			while (true)
			{
				...
				try
				{
					...
					else
					{
						...
						ProcessMessageInternal(new QueueMessageWrapper(queue, message, messageOptions.OverflowMessageContainer), queue, messageOptions, messageSpecificCancellationTokenSource, ref keepAliveTask);
					}
				}
