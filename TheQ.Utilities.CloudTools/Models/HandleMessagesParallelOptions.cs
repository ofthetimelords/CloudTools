...
namespace TheQ.Utilities.CloudTools.Storage.Models
{
	...
	/// </summary>
	public class HandleMessagesParallelOptions : HandleMessagesSerialOptions
	{
		/// <summary>
		///     <para>Initializes a new instance of the <see cref="HandleMessagesParallelOptions" /></para>
		///     <para>class.</para>
		/// </summary>
		...
		///     <para>An action that specifies how a poison message should be handled, which fires before <see cref="TheQ.Utilities.CloudTools.Storage.Models.HandleSerialOptions.MessageHandler" /></para>
		...
		/// </exception>
		public HandleMessagesParallelOptions(
			TimeSpan timeWindow,
